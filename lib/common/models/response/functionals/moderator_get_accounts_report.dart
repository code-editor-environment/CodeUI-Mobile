class ModeratorGetAccountsReport {
  Metadata? metadata;
  List<Data>? data;
  bool? isError;
  String? message;

  ModeratorGetAccountsReport(
      {this.metadata, this.data, this.isError, this.message});

  ModeratorGetAccountsReport.fromJson(Map<String, dynamic> json) {
    metadata =
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    reportImages = json["reportImages"] == null
        ? null
        : (json["reportImages"] as List)
            .map((e) => ReportImages.fromJson(e))
            .toList();
  }
