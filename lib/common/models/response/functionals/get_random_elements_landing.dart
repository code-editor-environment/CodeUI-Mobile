...
class GetRandomElements {
    ...
    GetRandomElements({this.metadata, this.data, this.isError, this.message});

    GetRandomElements.fromJson(Map<String, dynamic> json) {
...
class Data {
    ...
    Data({this.id, this.title, this.description, this.createDate, this.updateDate, this.isActive, this.status, this.categoryName, this.ownerUsername, this.collaborations, this.commentCount, this.likeCount, this.favorites, this.isLiked, this.isFavorite, this.profileResponse});
