...
class UserApprovedElementsListViewByCategoryFiltering extends StatefulWidget {
  const UserApprovedElementsListViewByCategoryFiltering({super.key});

  @override
  State<UserApprovedElementsListViewByCategoryFiltering> createState() =>
      _UserApprovedElementsListViewByCategoryFilteringState();
}

class _UserApprovedElementsListViewByCategoryFilteringState
    extends State<UserApprovedElementsListViewByCategoryFiltering> {
