...
class ViewOthersPendingElementsGuest extends StatefulWidget {
  const ViewOthersPendingElementsGuest({super.key});

  @override
  State<ViewOthersPendingElementsGuest> createState() =>
      _ViewOthersPendingElementsGuestState();
}

class _ViewOthersPendingElementsGuestState
    extends State<ViewOthersPendingElementsGuest> {
