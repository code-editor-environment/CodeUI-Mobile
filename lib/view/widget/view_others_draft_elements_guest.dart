...
class ViewOthersDraftElementsGuest extends StatefulWidget {
  const ViewOthersDraftElementsGuest({super.key});

  @override
  State<ViewOthersDraftElementsGuest> createState() =>
      _ViewOthersDraftElementsGuestState();
}

class _ViewOthersDraftElementsGuestState extends State<ViewOthersDraftElementsGuest> {
