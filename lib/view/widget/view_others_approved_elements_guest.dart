...
class ViewOthersApprovedElementsGuest extends StatefulWidget {
  const ViewOthersApprovedElementsGuest({super.key});

  @override
  State<ViewOthersApprovedElementsGuest> createState() =>
      _ViewOthersApprovedElementsGuestState();
}

class _ViewOthersApprovedElementsGuestState
    extends State<ViewOthersApprovedElementsGuest> {
