...
class UserGetApprovedElementsListViewByFilteringGuest extends StatefulWidget {
  const UserGetApprovedElementsListViewByFilteringGuest({super.key});

  @override
  State<UserGetApprovedElementsListViewByFilteringGuest> createState() =>
      _UserGetApprovedElementsListViewByFilteringGuestState();
}

class _UserGetApprovedElementsListViewByFilteringGuestState
    extends State<UserGetApprovedElementsListViewByFilteringGuest> {
