...
class ViewOthersRejectedElementsGuest extends StatefulWidget {
  const ViewOthersRejectedElementsGuest({super.key});

  @override
  State<ViewOthersRejectedElementsGuest> createState() =>
      _ViewOthersRejectedElementsGuestState();
}

class _ViewOthersRejectedElementsGuestState
    extends State<ViewOthersRejectedElementsGuest> {
