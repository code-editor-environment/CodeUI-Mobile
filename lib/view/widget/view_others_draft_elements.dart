...
class ViewOthersDraftElements extends StatefulWidget {
  const ViewOthersDraftElements({super.key});

  @override
  State<ViewOthersDraftElements> createState() =>
      _ViewOthersDraftElementsState();
}

class _ViewOthersDraftElementsState extends State<ViewOthersDraftElements> {
